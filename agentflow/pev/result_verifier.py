...
class ResultVerifier:
    ...
    _logger: logging.Logger = field(default_factory=lambda: logging.getLogger("agentflow.pev.verifier"))
    ...
    async def verify(
        ...
        self._logger.info(f"検証完了: 合格={verification.is_acceptable}, スコア={verification.score:.2f}")
