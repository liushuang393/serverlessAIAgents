...
from ..core.models import Message, MessageRole, ToolResult, ToolDefinition
...
"""
    ...
    async def _execute_single_tool_call(self, tool_call: ToolCall) -> ToolResult:
        ...
        try:
            ...
            logger.info(f"ツール '{tool_call.tool_name}' の実行完了 "
...
"""
    ...
    def _create_functions_schema(self, tools: List[ToolDefinition]) -> List[Dict[str, Any]]:
        """関数スキーマを作成する"""
        functions = []
        for tool in tools:
            function_schema = {
