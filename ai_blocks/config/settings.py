...
class Settings(BaseSettings):  # type: ignore[misc]
    ...
    anthropic_api_key: Optional[str] = Field(default=None, description="Anthropic APIキー")
    ...
    chroma_persist_directory: str = Field(default="./chroma_db", description="ChromaDB永続化ディレクトリ")
    ...
    # セキュリティ設定
    enable_input_sanitization: bool = Field(default=True, description="入力サニタイゼーションを有効にする")
