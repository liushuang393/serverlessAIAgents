...
class PersistentThread(ThreadInterface):
    ...
    def __init__(self, thread_id: str = None, storage_provider: Any = None, max_history: int = 100):
        """
        永続化対応のスレッドを初期化する
    ...
    @classmethod
    async def load_from_storage(cls, thread_id: str, storage_provider: Any) -> "PersistentThread":
        """
        ストレージからスレッドを読み込む
