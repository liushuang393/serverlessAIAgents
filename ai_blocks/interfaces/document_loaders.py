...
class HTMLLoader(DocumentLoader):
    ...
    def __init__(self, remove_scripts: bool = True, remove_styles: bool = True, **kwargs):
        """
        HTMLローダーを初期化する
    ...
    def supports(self, source: Union[str, Path]) -> bool:
        ...
        return (mime_type in ["text/html", "application/xhtml+xml"] or 
                str(source).lower().endswith(('.html', '.htm', '.xhtml')))
    ...
    async def load(self, source: Union[str, Path, bytes]) -> ParsedDocument:
        ...
        try:
            ...
            raise ImportError("beautifulsoup4パッケージがインストールされていません: pip install beautifulsoup4")
...
class ImageLoader(DocumentLoader):
    ...
    def supports(self, source: Union[str, Path]) -> bool:
        ...
        return (mime_type and mime_type.startswith('image/') or 
                str(source).lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp', '.tiff')))
    ...
    async def load(self, source: Union[str, Path, bytes]) -> ParsedDocument:
        ...
        try:
            ...
            raise ImportError("Pillow と pytesseract パッケージが必要です: pip install Pillow pytesseract")
...
class TextLoader(DocumentLoader):
    ...
    def supports(self, source: Union[str, Path]) -> bool:
        ...
        return (mime_type and mime_type.startswith('text/') or 
                str(source).lower().endswith(('.txt', '.md', '.rst', '.log')))
