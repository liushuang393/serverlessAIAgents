...
class ResourcePermission(Base):
    ...
    __table_args__ = (UniqueConstraint("role_id", "resource_type", "resource_id", name="uq_resource_perm"),)
...
class ResourceDefinition(Base):
    ...
    __table_args__ = (UniqueConstraint("resource_type", "resource_id", name="uq_resource_def"),)
    ...
    backend_key: Mapped[str] = mapped_column(String(100), default="shared", nullable=False)
    metadata_json: Mapped[str | None] = mapped_column("metadata", Text, nullable=True)  # JSON 文字列（SQLite 互換）
