...
# 2.5 Business Semantics Agent
business_semantics_card = AgentCard(
    name="business-semantics-agent",
    description="Extracts business processes, events, state model, and rules from legacy analysis.",
    version="1.0.0",
    skills=[
        AgentSkill(
            name="derive_business_semantics",
            description="Transform technical analysis into business semantics artifacts.",
            input_schema={
                "type": "object",
                "properties": {
