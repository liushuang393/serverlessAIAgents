...
class TestGatekeeperAgentPatterns:
    ...
    @pytest.mark.asyncio
    async def test_reject_weather_question_via_process(self, gatekeeper_agent: GatekeeperAgent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_reject_system_question_via_process(self, gatekeeper_agent: GatekeeperAgent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_reject_short_greeting_via_process(self, gatekeeper_agent: GatekeeperAgent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_accept_resource_allocation_via_process(self, gatekeeper_agent: GatekeeperAgent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_now_word_in_decision_question_is_not_auto_rejected(self, gatekeeper_agent: GatekeeperAgent) -> None:
...
class TestGatekeeperAgentProcess:
    ...
    @pytest.mark.asyncio
    async def test_process_rejects_instant_reject_pattern(self, gatekeeper_agent: GatekeeperAgent) -> None:
    ...
    @pytest.mark.asyncio
    async def test_process_accepts_decision_question(self, gatekeeper_agent: GatekeeperAgent) -> None:
        """Test that process accepts valid decision questions."""
        # Use a longer question with decision keywords to ensure acceptance
        input_data = GatekeeperInput(raw_question="新製品への投資判断をしたい。予算配分とリスク評価が必要。")
        result = await gatekeeper_agent.process(input_data)
