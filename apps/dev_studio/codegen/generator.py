...
from apps.dev_studio.codegen.builders.backend import BackendBuilder
from apps.dev_studio.codegen.builders.frontend import FrontendBuilder
from apps.dev_studio.codegen.builders.fullstack import FullstackBuilder
...
class CodeGenerator(ICodeGenerator):
    ...
    async def generate(
        ...
        """
        if options is None:
            options = CodeGenOptions(app_name=workflow.name.lower().replace(" ", "-") or "bizcore-app")
        elif not options.app_name:
            options.app_name = workflow.name.lower().replace(" ", "-") or "bizcore-app"
