...
from agentflow.security.oauth2_provider import OAuth2Provider, ExternalIdentity
...
from apps.faq_system.backend.auth.service import get_auth_service, AuthService, AuthProvider
from apps.faq_system.backend.auth.router import AuthResponse, _SESSION_COOKIE_MAX_AGE
...
async def callback(
    ...
    try:
        ...
        # Log error
        import logging
        logging.error(f"OAuth2 exchange failed: {e}")
