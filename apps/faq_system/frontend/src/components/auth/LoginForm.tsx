...
export const LoginForm = () => {
  ...
  const trustSignals = [
    {
      key: "knowledge",
      title: t("auth.trust.knowledge"),
      description: t("auth.trust.knowledge_desc"),
    },
    {
      key: "security",
      title: t("auth.trust.security"),
      description: t("auth.trust.security_desc"),
    },
    {
      key: "efficiency",
      title: t("auth.trust.efficiency"),
      description: t("auth.trust.efficiency_desc"),
    },
  ];
  ...
  return (
    <div className="login-shell">
      <div
        className="login-shell__blob login-shell__blob--one"
        aria-hidden="true"
      />
      <div
        className="login-shell__blob login-shell__blob--two"
        aria-hidden="true"
      />
