...
const ROLE_KB_MAP = [
  { role: 'admin', kbs: ['internal', 'external', 'confidential'], color: 'text-rose-400' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-indigo-500/5 border border-indigo-500/10">
        ...
        <div>
          <p className="text-sm text-white mb-1">{t('rag.access_control_title')}</p>
      ...
      <div className="p-4 rounded-xl bg-white/[0.02] border border-white/5 text-xs text-[var(--text-muted)]">
        <p className="mb-1 font-medium text-white">{t('rag.access_note_title')}</p>
