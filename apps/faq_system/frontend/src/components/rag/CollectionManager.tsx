            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-[var(--text-muted)]">
                  {col.collection_name} &middot; {col.document_count} docs
                  &middot; {col.chunk_strategy}/{col.chunk_size}
                </p>
              </div>
            </button>
