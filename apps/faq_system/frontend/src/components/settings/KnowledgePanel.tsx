...
import { Settings2, X, Database, FileText, Search, Shield, BarChart3, Clock } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-white/5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-bold text-white">{t('knowledge_panel.title')}</h2>
        </div>
        <button
          onClick={onClose}
