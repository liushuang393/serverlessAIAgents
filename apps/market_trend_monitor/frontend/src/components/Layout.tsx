  ...
  const menuItems = [
    {
      ...
      secondary: t("nav.dashboard_desc"),
      icon: <DashboardIcon />,
      path: "/dashboard",
    },
    {
      text: t("nav.signals"),
      secondary: t("nav.signals_desc"),
      icon: <SignalIcon />,
      path: "/signals",
    },
    {
      text: t("nav.evidence"),
      secondary: t("nav.evidence_desc"),
      icon: <EvidenceIcon />,
      path: "/evidence",
    },
    {
      text: t("nav.predictions"),
      secondary: t("nav.predictions_desc"),
      icon: <PredictionIcon />,
      path: "/predictions",
    },
    {
      text: t("nav.competitor"),
      secondary: t("nav.competitor_desc"),
      icon: <CompetitorIcon />,
      path: "/competitors",
    },
    {
      text: t("nav.reports"),
      secondary: t("nav.reports_desc"),
      icon: <ReportIcon />,
      path: "/reports",
    },
    {
      text: t("nav.settings"),
      secondary: t("nav.settings_desc"),
      icon: <SettingsIcon />,
      path: "/settings",
    },
  ];
