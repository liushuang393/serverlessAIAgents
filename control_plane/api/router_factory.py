...
使用例:
    >>> from control_plane.api import create_agent_router, create_websocket_router
    >>>
    >>> # Agent ルーター（REST + SSE）
...
from control_plane.api.response import APIResponse, ErrorCode
from control_plane.api.sse_emitter import SSEEmitter
