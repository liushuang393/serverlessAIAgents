...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "init_builder_services": ("control_plane.routers.builder", "init_builder_services"),
    "init_dev_studio_services": ("control_plane.routers.dev_studio", "init_dev_studio_services"),
