...
from control_plane.code_intelligence.ast.unified_ast import (
    ASTNode,
    ASTNodeType,
    SymbolInfo,
    TypeInfo,
...
from control_plane.code_intelligence.parsers.base import (
    CodeParser,
    ParseContext,
    ParseError,
    ParseResult,
...
def _register() -> None:
    """パーサーをレジストリに登録."""
    try:
        from control_plane.code_intelligence.parsers.registry import register_parser
