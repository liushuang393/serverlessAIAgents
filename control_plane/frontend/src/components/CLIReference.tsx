  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        usage: 'python -m control_plane.main publish ./my-agent --target docker',
    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-400">
          BizCore CLI と control-plane CLI のコマンド一覧です。ターミナルからフレームワーク機能を操作できます。
        </p>
      </div>
      ...
      <div className="mt-10 bg-slate-800/30 border border-slate-700/50 rounded-lg p-6">
        ...
        <div className="space-y-3 font-mono text-sm">
          ...
          <div className="bg-slate-900/60 rounded px-4 py-3">
            ...
            <p className="text-emerald-400">$ python -m control_plane.main serve</p>
          </div>
          <div className="bg-slate-900/60 rounded px-4 py-3">
            <p className="text-slate-500 mb-1"># フロントエンド起動（別ターミナル）</p>
            <p className="text-emerald-400">$ cd control_plane/frontend &amp;&amp; npm run dev</p>
          </div>
          <div className="bg-slate-900/60 rounded px-4 py-3">
            <p className="text-slate-500 mb-1"># 新しいエージェントを作成して実行</p>
            <p className="text-emerald-400">$ bizcore init my-agent</p>
            <p className="text-emerald-400">$ bizcore run my-agent --input '&#123;"question": "Hello"&#125;'</p>
          </div>
        </div>
      </div>
    </div>
