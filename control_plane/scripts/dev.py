...
def main() -> None:
    ...
    target_module = "control_plane.main"
    # Platform needs 'serve' arg usually
    cmd: list[str] = [sys.executable, "-m", target_module, "serve"]
    ...
    if (not user_args or user_args[0] == "serve") and "--reload" not in user_args:
        ...
        print("      Use: python control_plane/scripts/dev.py serve --reload")
