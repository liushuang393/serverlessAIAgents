...
from control_plane.marketplace.registry import LocalRegistry
...
def create_app(
    ...
    Returns:
        FastAPI アプリケーション
    """
    from control_plane.ui.studio.routes import (
    ...
    if agents_dir is None:
        agents_dir = Path.home() / ".bizcore" / "agents"
    if workflows_dir is None:
        workflows_dir = Path.home() / ".bizcore" / "workflows"
