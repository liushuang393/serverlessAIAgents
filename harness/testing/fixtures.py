...
使用例:
    >>> # conftest.py で
    >>> from harness.testing.fixtures import mock_llm_fixture, agent_fixture
    >>>
    >>> @pytest.fixture
...
from harness.testing.mock_llm import MockLLMProvider, create_mock_llm
...
def mock_llm_fixture(
    ...
    # グローバル LLM を置き換え
    from infrastructure.llm.providers import llm_provider as llm_provider_module
...
def pytest_fixtures() -> dict[str, Any]:
    ...
    conftest.py で使用:
        >>> from harness.testing.fixtures import pytest_fixtures
...
import pytest
from harness.testing import MockLLMProvider, create_mock_llm
...
def mock_llm():
    ...
    # グローバル LLM を置き換え
    from infrastructure.llm.providers import llm_provider
...
async def agent_context():
    ...
    from harness.testing.agent_test_framework import agent_test_context
