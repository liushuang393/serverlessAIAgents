...
使用例（アプリの env.py）:
    ...
    >>> from infrastructure.storage.database.migration import MigrationEnv
    >>>
    >>> MigrationEnv(
...
from infrastructure.storage.database.url_utils import is_sqlite, to_async_url, to_sync_url
