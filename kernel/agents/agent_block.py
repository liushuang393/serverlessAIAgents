...
class AgentBlock(ABC):
    ...
    def __init_subclass__(cls, **kwargs: object) -> None:
        ...
        # agentflow フレームワーク内部クラスは除外
        if AgentBlock in cls.__bases__ and not cls.__module__.startswith("agentflow."):
            warnings.warn(
    ...
    def __init__(
        ...
        if engine is None:
            from kernel.core.engine import AgentFlowEngine as _Engine
    ...
    def load_metadata(self, metadata_path: str | Path | None = None) -> AgentMetadata:
        ...
        from kernel.core.schemas import SchemaLoader as _SchemaLoader
