...
from kernel.memory.knowledge.knowledge_manager import KnowledgeManager
from kernel.memory.knowledge.memory_store import InMemoryKnowledgeStore
from kernel.memory.knowledge.memvid_store import is_memvid_available
from kernel.memory.knowledge.types import KnowledgeEntry, KnowledgeSource
...
def get_knowledge_store(*, backend: str = "memory") -> InMemoryKnowledgeStore:
    ...
    if backend == "auto" and is_memvid_available():
        from kernel.memory.knowledge.memvid_store import MemvidKnowledgeStore
