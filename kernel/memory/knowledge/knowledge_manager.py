...
from kernel.memory.knowledge.memvid_store import (
    MemvidKnowledgeStore,
    is_memvid_available,
)
from kernel.memory.knowledge.types import (
    KnowledgeEntry,
    KnowledgeSource,
    SearchResult,
    SearchType,
...
if TYPE_CHECKING:
    from kernel.memory.knowledge.knowledge_store import KnowledgeStore
