...
from kernel.memory.sensory_memory import SensoryMemory
from kernel.memory.short_term_memory import ShortTermMemory


if TYPE_CHECKING:
    from infrastructure.memory.types import CompressionConfig, MemoryEntry
    from kernel.memory.fact_atomizer import FactAtomizer
