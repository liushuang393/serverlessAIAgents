...
使用例:
    >>> from plugins.infrastructure_skills.market_trend_analysis.scripts.generate_report_skeleton import (
    ...
    for section in sections:
        ...
        if section_type == "summary":
            ...
            for item in section.get("items", []):
                ...
                lines.append(
                    f"| {item['rank']} | {item['topic']} | {item['score']:.2f} | {item['sentiment']} | {growth_pct} |"
                )
