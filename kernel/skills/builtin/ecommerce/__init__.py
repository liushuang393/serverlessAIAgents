...
register_submodule_alias(
    ...
    ["ad_monitor", "competitor_scraper", "daily_report",
     "inventory_adjuster", "listing_generator", "price_analyzer"],
)

from plugins.ecommerce_skills.ecommerce import *  # noqa: F401,F403
