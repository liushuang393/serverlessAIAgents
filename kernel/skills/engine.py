...
from kernel.skills.generator import SkillGenerator
from kernel.skills.loader import SkillLoader, SkillRegistry
from kernel.skills.matcher import MatchResult, SkillMatcher
...
class SkillEngine:
    ...
    async def _resolve_internal(self, query: str, depth: int = 0, max_depth: int = 3) -> SkillExecutionResult:
        """内部解決ロジック（依存解決の再帰対応）.
