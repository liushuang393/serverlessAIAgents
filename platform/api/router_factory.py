...
使用例:
    >>> from platform.api import create_agent_router, create_websocket_router
    >>>
    >>> # Agent ルーター（REST + SSE）
...
from platform.api.response import APIResponse, ErrorCode
from platform.api.sse_emitter import SSEEmitter
