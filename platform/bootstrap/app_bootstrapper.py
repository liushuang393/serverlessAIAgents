...
if TYPE_CHECKING:
    ...
    from platform.bootstrap.config_watcher import ConfigWatcher
...
class AppCapabilityBootstrapper:
    ...
    async def build(
        ...
        from platform.bootstrap.capability_bundle import CapabilityBundle
        from platform.bootstrap.config_watcher import ConfigWatcher
        from platform.bootstrap.rag_builder import build_rag_engine
        from platform.bootstrap.skill_builder import build_skill_gateway
