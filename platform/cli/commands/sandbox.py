...
def create_sandbox(
    ...
    """サンドボックスを作成."""
    from infrastructure.sandbox import ManagedSandbox, SandboxConfig
...
def list_sandboxes(state: str | None, as_json: bool) -> None:
    """サンドボックス一覧を表示."""
    from infrastructure.sandbox import SandboxState, get_sandbox_manager
...
def start_sandbox(sandbox_id: str) -> None:
    """サンドボックスを起動."""
    from infrastructure.sandbox import get_sandbox_manager
