...
from platform.deploy.targets.aws_lambda import AWSLambdaTarget
from platform.deploy.targets.docker import DockerTarget
from platform.deploy.targets.github_actions import GitHubActionsTarget
from platform.deploy.targets.vercel import VercelTarget


if TYPE_CHECKING:
    from collections.abc import AsyncIterator

    from platform.deploy.targets.base import BaseDeployTarget
