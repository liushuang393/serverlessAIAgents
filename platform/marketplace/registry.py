...
class LocalRegistry:
    ...
    def add_agent(self, entry: AgentRegistryEntry) -> None:
        ...
        # 既存エントリを削除
        data["agents"] = [agent for agent in data["agents"] if agent.get("id") != entry.id]
    ...
    def remove_agent(self, agent_id: str) -> bool:
        ...
        data["agents"] = [agent for agent in data["agents"] if agent.get("id") != agent_id]
    ...
    def list_agents(self) -> list[AgentRegistryEntry]:
        ...
        return [AgentRegistryEntry.model_validate(agent) for agent in data["agents"]]
