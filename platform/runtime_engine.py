...
from platform.dashboards.runtime import TenantDashboard
from platform.publish.contracts import PublishResponse
...
if TYPE_CHECKING:
    ...
    from platform.publish.contracts import PublishEvent, PublishRequest


class PlatformEngine(SimpleEngine):
    """Platform エンジン.

    Gallery、公開、ダッシュボードを統合した Layer 5 実行窓口。
    """
