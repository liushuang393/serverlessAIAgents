...
Example:
    >>> from platform.sdk.api import create_agent_router
...
from platform.sdk.api.errors import AgentApiException, ErrorCode
from platform.sdk.api.sse import create_sse_response
