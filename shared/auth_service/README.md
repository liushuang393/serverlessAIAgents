...
python shared/auth_service/scripts/dev.py
```
...
```bash
# .env を設定
cp shared/auth_service/.env.example shared/auth_service/.env
...
```bash
python shared/auth_service/scripts/compose.py publish
```
...
```bash
# 起動
uvicorn shared.auth_service.main:app --port 8010 --reload
...
python shared/auth_service/scripts/compose.py publish
curl http://localhost:8010/health
python shared/auth_service/scripts/compose.py stop

# 5. 認可テスト
pytest tests/shared/auth_service/test_authorization_models.py -v
pytest tests/shared/auth_service/test_authorization_service.py -v
pytest tests/shared/auth_service/test_authorization_api.py -v
pytest tests/shared/auth_service/test_authorization_e2e.py -v

# 6. 全テスト一括実行
pytest tests/shared/auth_service/ -v --no-cov
```
