...
from infrastructure.memory.types import MemoryEntry, MemoryStability
...
class ImportanceAdjuster:
    ...
    async def apply_reinforcement(
        ...
        if entry.reinforcement_score > 0.5:
            ...
            elif entry.stability == MemoryStability.CONSOLIDATED and entry.reinforcement_score > 0.8:
