...
from shared.memory.knowledge.memvid_store import (
    MemvidKnowledgeStore,
    is_memvid_available,
)
from shared.memory.knowledge.types import (
    KnowledgeEntry,
    KnowledgeSource,
    SearchResult,
    SearchType,
...
if TYPE_CHECKING:
    from shared.memory.knowledge.knowledge_store import KnowledgeStore
