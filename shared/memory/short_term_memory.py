...
from infrastructure.memory.types import MemoryEntry, MemoryType, TopicBuffer
...
class ShortTermMemory:
    ...
    async def add_entry(
        ...
        self._logger.debug(f"Added entry to topic '{topic}': {self._buffers[topic].total_tokens} tokens")
