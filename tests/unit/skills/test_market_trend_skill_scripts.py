...
SCRIPTS_DIR = (
    ...
    / "agentflow/skills/builtin/market-trend-analysis/scripts"
)
...
class TestValidateInput:
    ...
    def test_missing_required_fields(self) -> None:
        ...
        result = module.validate_articles_input({"articles": [{"content": "only content"}]})
...
class TestExtractKeywords:
    ...
    def test_tech_keywords_boost(self) -> None:
        ...
        assert "cobol" in [k.lower() for k in result.keywords]
    ...
    def test_existing_keywords_boost(self) -> None:
        ...
        # 既存キーワードは重み2倍
        assert "ai" in [k.lower() for k in result.keywords]
