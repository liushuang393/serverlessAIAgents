...
class TestGenerateDockerfile(unittest.TestCase):
    ...
    def test_with_kwargs(self):
        """使用 kwargs 测试."""
        from control_plane.deploy.docker_generator import generate_dockerfile
...
class TestGenerateDockerCompose(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.docker_generator import generate_docker_compose
    ...
    def test_with_env_vars(self):
        """带环境变量测试."""
        from control_plane.deploy.docker_generator import DockerConfig, generate_docker_compose
...
class TestGenerateDockerIgnore(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.docker_generator import generate_dockerignore
...
class TestGenerateVercelConfig(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.serverless_generator import generate_vercel_config
    ...
    def test_with_env_vars(self):
        """带环境变量测试."""
        from control_plane.deploy.serverless_generator import ServerlessConfig, generate_vercel_config
...
class TestGenerateAWSLambdaConfig(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.serverless_generator import generate_aws_lambda_config
    ...
    def test_with_config(self):
        """带配置测试."""
        from control_plane.deploy.serverless_generator import (
            ServerlessConfig,
...
class TestGenerateRequirementsTxt(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.serverless_generator import generate_requirements_txt
...
class TestGenerateGitHubActions(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.ci_cd_generator import generate_github_actions
...
class TestGenerateGitLabCI(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.ci_cd_generator import generate_gitlab_ci
    ...
    def test_with_config(self):
        """带配置生成测试."""
        from control_plane.deploy.ci_cd_generator import CICDConfig, generate_gitlab_ci
...
class TestGeneratePreCommitConfig(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy.ci_cd_generator import generate_pre_commit_config
...
class TestDeployModuleExports(unittest.TestCase):
    ...
    def test_imports(self):
        """导入测试."""
        from control_plane.deploy import (
            generate_all,
...
class TestGenerateAll(unittest.TestCase):
    ...
    def test_basic_generation(self):
        """基本生成测试."""
        from control_plane.deploy import generate_all
